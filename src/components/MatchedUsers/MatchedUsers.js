...
const MatchedUsers = () => (
  <div>
    <ul> Matched Users:
      ...
      <li>♑︎ twoborgs 💖<button className='send-message'>Send Message</button><button className='view-profile'>View Profile</button></li>
      <li>♓︎ femmeicon 💖<button className='send-message'>Send Message</button><button className='view-profile'>View Profile</button></li>
    </ul>
  </div>
);
